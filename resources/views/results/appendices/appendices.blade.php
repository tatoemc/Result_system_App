...
<div class="row"> 
    <div class="col-md-8 col-md-offset-2">
     ...
     <div class="alert alert-success" role="alert"> أدخال نتيجة الملحق لمادة : </div>
    </div>

   <div class="col-md-8 col-md-offset-2">
    {!! Form::open(['route' => 'appendices.appendices', 'data-parsley-validate' => '','method'=>'POST','enctype'=>'multipart/form-data' ]) !!}
         {{csrf_field()}}
          {{ method_field('get') }}
